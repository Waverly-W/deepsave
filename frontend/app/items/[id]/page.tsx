            ...
            <article className="rounded-3xl border border-neutral-200/70 bg-white/85 p-6 shadow-xl backdrop-blur dark:border-neutral-800/60 dark:bg-neutral-900/70">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-xs text-neutral-500 dark:text-neutral-400">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-full border border-neutral-200 px-3 py-1 transition hover:text-neutral-900 dark:border-neutral-800 dark:hover:text-neutral-100"
                >
              ...
              <div className="mt-8 text-sm leading-7 text-neutral-700 dark:text-neutral-200">
                <ItemMarkdownEditor
                  itemId={item.id}
